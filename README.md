...
| 김동현 | 백엔드               | 1. 유저 DB 설계 및 API 개발<br>2. 학습 이력에 따른 포인트 반환하는 기능 추가<br>3. jwt token 설정<br>4. jest test file 작성<br>5. swagger 작성<br> 6. 수화 영상 DB 생성 <br> 7. docker 배포                                                                                                                                                                                                                                                                                        |
